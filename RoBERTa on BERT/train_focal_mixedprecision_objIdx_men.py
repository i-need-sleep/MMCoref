...
def train():
    ...
    # Setup Tensorboard
    writer = SummaryWriter(comment = f'RobertaOnBERT_ObjidxMen batch_size={BATCH_SIZE}, Adam_lr={LR}, Gamma={GAMMA}, Alpha={ALPHA}')
    ...
    class Roberta_on_KB_emb(torch.nn.Module):
        def __init__(self, device):
            ...
            self.obj_men_emb = torch.nn.Embedding(200, 768)
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            if batch_idx % 500 == 0:
                ...
                torch.save({
                    ...
                    'dev_loss': loss,
                    }, f'./checkpoint/RobertaOnBERT_focal_mixed_ObjIdxMen_batchsize{BATCH_SIZE}_lr{LR}_Gamma{GAMMA}_Alpha{ALPHA}_{epoch}_{batch_idx}_{loss}_{f1}.bin')
    print('DONE !!!')
