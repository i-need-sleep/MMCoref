...
def train():
    ...
    # Setup Tensorboard
    writer = SummaryWriter(comment = f'RobertaOnBERT batch_size={BATCH_SIZE}, Adam_lr={LR}')
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            if batch_idx % 500 == 0:
                ...
                torch.save({
                    ...
                    'dev_loss': loss,
                    }, f'./checkpoint/RobertaOnBERT_batchsize{BATCH_SIZE}_lr{LR}_{epoch}_{batch_idx}_{loss}_{f1}.bin')
    print('DONE !!!')
