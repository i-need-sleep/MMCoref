...
def train():
    ...
    GAMMA = 2
    ALPHA = 5
    print(f'UNITERonCLIPBERT_sceneseg batch_size={BATCH_SIZE}, Adam_lr={LR}, FocalAlpha={ALPHA}, GAMMA={GAMMA}')
    ...
    # Setup Tensorboard
    writer = SummaryWriter(comment = f'UNITERonCLIPBERT_sceneseg batch_size={BATCH_SIZE}, Adam_lr={LR}, FocalAlpha={ALPHA}, GAMMA={GAMMA}')
    ...
    for epoch in range(N_EPOCH):
        for batch_idx, batch in enumerate(train_loader):
            ...
            if batch_idx % 2000 == 0:
                ...
                try:
                    os.makedirs(f'./checkpoint/UNITERonCLIPBERT_sceneseg_batchsize{BATCH_SIZE}_lr{LR}_FocalALPHA{ALPHA}_GAMMA{GAMMA}')
                except:
                    pass
                ...
                torch.save({
                    ...
                    'dev_loss': loss,
                    }, f'./checkpoint/UNITERonCLIPBERT_sceneseg_batchsize{BATCH_SIZE}_lr{LR}_FocalALPHA{ALPHA}_GAMMA{GAMMA}/{epoch}_{batch_idx}_{loss}_{f1}.bin')
    print('DONE !!!')
