...
# Get Loaders
train_loader = make_loader('train', BATCH_SIZE, MAX_N_OBJ)
dev_loader = make_loader('dev', BATCH_SIZE, MAX_N_OBJ)
    ...
    for idx, batch in enumerate(train_loader):
        ...
        if idx % 500 == 0:
            ...
            torch.save({
                ...
                'dev_loss': loss,
                }, f'./checkpoint/baselineRoberta_batchsize{BATCH_SIZE}_lr{LR}_{epoch}_{idx}_{loss}_{f1}.bin')
print('DONE !!!')