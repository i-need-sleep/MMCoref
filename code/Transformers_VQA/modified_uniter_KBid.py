...
class Modified_Uniter_KBid(torch.nn.Module):
    def __init__(self):
        super(Modified_Uniter_KBid, self).__init__()
        ...
        self.KBid_emb = torch.nn.Embedding(500, 1024, padding_idx=0)
    ...
    def forward(self, input_ids , txt_seg_ids, vis_feats, KB_ids, obj_ids, pos_x, pos_y, pos_z, bboxes, vis_seg, extended_attention_mask):
