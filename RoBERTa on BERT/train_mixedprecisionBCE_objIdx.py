...
def train():
    ...
    # Setup Tensorboard
    writer = SummaryWriter(comment = f'RobertaOnBERT_Objidx batch_size={BATCH_SIZE}, Adam_lr={LR}, BCEweigh={ALPHA}')
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            if batch_idx % 500 == 0:
                ...
                torch.save({
                    ...
                    'dev_loss': loss,
                    }, f'./checkpoint/RobertaOnBERT_mixed_ObjIdx_batchsize{BATCH_SIZE}_lr{LR}_BCEweigh{ALPHA}_{epoch}_{batch_idx}_{loss}_{f1}.bin')
    print('DONE !!!')
