...
class Modified_Uniter_attnbias_rcnn(torch.nn.Module):
    def __init__(self):
        super(Modified_Uniter_attnbias_rcnn, self).__init__()
        ...
        # Convert input (Ojb_idx: 512, KB: 1024, visual: 512+2048, pos: 3*128, scene_seg: 128)
        ...
        self.emb_bag = torch.nn.Linear(2048+512+2048, 2048)
