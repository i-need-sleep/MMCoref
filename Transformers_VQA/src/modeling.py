...
class BertAttention(nn.Module):
    ...
    def forward(self, hidden_states, context, attention_mask=None, rel_masks=None):
        ...
        # Attention bias
        if rel_masks:
            rel_mask_left, rel_mask_right, rel_mask_up, rel_mask_down = [i for i in rel_masks]
...
class BertSelfattLayer(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, rel_masks=None):
...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, rel_masks=None):
        attention_output = self.attention(hidden_states, attention_mask, rel_masks)
...
class BertEncoder(nn.Module):
    ...
    def forward(self,hidden_states,attention_mask=None, rel_masks=None):
        all_attentions = ()
        for i, layer_module in enumerate(self.layer):
            layer_outputs = layer_module(hidden_states,attention_mask, rel_masks)
